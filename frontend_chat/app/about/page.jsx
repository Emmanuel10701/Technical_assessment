  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">
                  {title.split(" ")[0]} <span className={`bg-gradient-to-r from-${color}-500 to-${color}-700 text-transparent bg-clip-text`}>{title.split(" ").slice(1).join(" ")}</span>
                </h2>
              </div>
        ...
        <button
          onClick={() => router.push("/")}
          className={`px-6 py-2 bg-transparent border border-gray-500 mt-10 rounded-full shadow hover:bg-gray-500 hover:text-white transition-all ${theme === "dark" ? "text-gray-100" : "text-gray-800"}`}
        >
          Go Back
        </button>
      </div>
